...
class CouldNotSendNotification extends \Exception
{
    ...
    {
        return new static('The notifiable did not have a phone number. Add routeNotificationForInfoBip
        to your notifiable');
    }
    ...
    public static function invalidMessageObject($message)
    {
        ...
        return new static(
            ...
            be either `".InfobipMessage::class.'` or `'.InfobipSmsAdvancedMessage::class.'`');
    }
}
